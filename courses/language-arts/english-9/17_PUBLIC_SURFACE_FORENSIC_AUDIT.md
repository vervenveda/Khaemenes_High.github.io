...
### HIGH 03 — No dedicated weekly quiz / canonical unit-test implementation — OPEN

The 36-week course frequently references defined scored checks at ≥80%, but no dedicated `quizzes/` directory or canonical unit-test engine is presently identified. Unit gates rely on locally entered verified scores.

Next disposition:
- classify every weekly check as practice, human-reviewed evidence, or canonical mastery evidence
- create a 12-unit assessment map and unit evidence contract
- use Pre-Algebra as the structural benchmark without reducing Language Arts mastery to objective items where writing/speaking performance is the correct evidence
