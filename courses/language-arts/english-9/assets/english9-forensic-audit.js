...
window.__KHAEMENES_ENGLISH9_FORENSIC_AUDIT__={generatedAt:new Date().toISOString(),counts:{weekly:weekly.length,midterm:mid.length,final:fin.length,total:all.length},answerPositions:positions,issues,exactPromptDuplicates,weeklyOverlap:{midterm:midOverlap,final:finalOverlap}};
})();`;
