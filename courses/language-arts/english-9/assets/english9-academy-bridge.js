(() => {
  ...
  if(formal){
    ...
    status.innerHTML="<strong>Academy-connected record.</strong> English 9 progress is learner-scoped. Formal progression uses an 80% mastery gate: complete the learning sequence, reach 80% on the weekly mastery check, and the next week opens.";
  }else{
