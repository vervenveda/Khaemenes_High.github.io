...
function weekUnlocked(week){if(cfg.mode!=="formal")return true;if(week<=1)return true;if(scoreFor(week-1)<PASS)return false;if(week>=19&&midtermBest()<PASS)return false;return true}
...
function reasonForWeek(week){if(week>=19&&midtermBest()<PASS)return "Semester II opens after Weeks 1–18 are mastered and the Science midterm objective score reaches 80% or higher.";return "Week "+week+" opens after Week "+(week-1)+" reaches 80% mastery."}
