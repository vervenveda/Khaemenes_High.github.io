(() => {
  ...
  if(formal){
    ...
    status.innerHTML="<strong>Academy-connected science record.</strong> Course progress, pathway preference, notebook work, mastery checks, and safety evidence are stored under the active Grade 09 learner.";
  }else{
