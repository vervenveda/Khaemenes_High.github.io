...
const all=window.GEOMETRY_UNIT09_QUESTIONS;
...
function score(token){
 ...
 const score=Math.round(right/set.length*100),data=records(),key=cfg.recordKey||"unit-09";
