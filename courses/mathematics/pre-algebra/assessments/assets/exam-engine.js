...
(function(){
 ...
 /*
   ...
   - Question data keeps its canonical option indexes and verified answer index.
   - Display positions are deterministically shuffled, so saved drafts never move on reload.
   - The target correct-answer positions are globally balanced before shuffling, preventing
     a predictable A/B/C/D cycle without rewriting mathematical content or answer keys.
 */
